...
describe('Definition generation', () => {
  ...
  const dynamicMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/getController.ts', undefined, undefined, ['./__tests__/fixtures/controllers/getController.ts']).Generate();
