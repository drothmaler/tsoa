...
describe('Metadata generation', () => {
  const metadata = new MetadataGenerator('./__tests__/fixtures/controllers/getController.ts').Generate();
  ...
  describe('DynamicControllerGenerator', () => {
    it("should should throw 'globs found 0 controllers.'", () => {
      expect(() => {
        ...
        const NON_CONTROLLER_EXISTS_GLOB = './__tests__/unit/swagger';
        new MetadataGenerator('./__tests__/fixtures/express-dynamic-controllers/server.ts', undefined, [], [NON_CONTROLLER_EXISTS_GLOB]).Generate();
      }).to.throw(/globs found 0 controllers./);
    });
  });

  describe('MethodGenerator', () => {
    const parameterMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/methodController.ts').Generate();
  ...
  describe('ParameterGenerator', () => {
    const parameterMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/parameterController.ts').Generate();
    const controller = parameterMetadata.controllers[0];
  ...
  describe('HiddenMethodGenerator', () => {
    const parameterMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/hiddenMethodController.ts').Generate();
    const controller = parameterMetadata.controllers[0];
  ...
  describe('HiddenControllerGenerator', () => {
    const parameterMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/hiddenController.ts').Generate();
    const controller = parameterMetadata.controllers[0];
  ...
  describe('DeprecatedMethodGenerator', () => {
    const parameterMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/deprecatedController.ts').Generate();
    const controller = parameterMetadata.controllers[0];
