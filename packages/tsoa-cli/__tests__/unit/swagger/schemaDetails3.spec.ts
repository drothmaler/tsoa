...
describe('Definition generation for OpenAPI 3.0.0', () => {
  ...
  describe('paths', () => {
    describe('requestBody', () => {
      it('should replace the body parameter with a requestBody', () => {
        const metadataPost = new MetadataGenerator('./__tests__/fixtures/controllers/postController.ts').Generate();
    ...
    describe('hidden paths', () => {
      it('should not contain hidden paths', () => {
        const metadataHiddenMethod = new MetadataGenerator('./__tests__/fixtures/controllers/hiddenMethodController.ts').Generate();
      ...
      it('should not contain paths for hidden controller', () => {
        const metadataHiddenController = new MetadataGenerator('./__tests__/fixtures/controllers/hiddenController.ts').Generate();
  ...
  describe('illegal input values', () => {
    ...
    it('should warn if an enum is mixed with numbers and strings', () => {
      ...
      const mixedEnumMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/mixedEnumController.ts').Generate();
