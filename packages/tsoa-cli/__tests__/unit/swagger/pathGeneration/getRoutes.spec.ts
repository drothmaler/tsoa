...
describe('GET route generation', () => {
  ...
  it('should generate a path for a GET route with no controller path argument', () => {
    const pathlessMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/pathlessGetController.ts').Generate();
  ...
  it('should reject complex types as arguments', () => {
    expect(() => {
      const invalidMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/invalidGetController.ts').Generate();
