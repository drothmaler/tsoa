...
describe('POST route generation', () => {
  const metadata = new MetadataGenerator('./__tests__/fixtures/controllers/postController.ts').Generate();
  ...
  it('should reject multiple body parameters', () => {
    chai
      .expect(() => {
        const invalidMetadata = new MetadataGenerator('./__tests__/fixtures/controllers/invalidPostController.ts').Generate();
